...
9. Expand the optional parameters. For this text generation scenario, use temperature `0.8`, set max_net tokens to `200`, set min_new_tokens to `50` and set repetition penalty to `2`, set decoding_method to `sample`. Then click on **Apply**
