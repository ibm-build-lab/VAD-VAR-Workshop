...
<img src="./images/2.4.png" width="80%" alt="prompt" />
...
<img src="./images/2.7.png" width="80%" alt="prompt" />
...
<img src="./images/2.8.png" width="85%" akt="Repeated text" />
...
See: [Example answer](109.md#1-generate)
...
See: [Example answer](109.md#2-rewrite)
...
See: [Example answer](109.md#3-summarize)
...
See: [Example answer](109.md#4-text-extraction)
