...
2. Utilice el menú desplegable para elegir entre diferentes modelos de cimientos.
...
5. Salida de ejemplo (correspondiente a los inputs del punto 4).
    ...
    <br/>**One-shot prompting:** a single input/output ex
...
2.  Seleccione **Generación de mensajes de marketing** de la lista de ejemplos de la izquierda. Esta pregunta solicita un mensaje de marketing de 5 frases basado en las características proporcionadas.
    ...
    ```
    Generar un mensaje de marketing de 5 frases para una empresa con las características dadas.
    ```
...
7. Haga clic en **Ver todos los modelos de cimientos**
     ...
     Esto abrirá el siguiente panel de modelos de cimentación disponibles.
