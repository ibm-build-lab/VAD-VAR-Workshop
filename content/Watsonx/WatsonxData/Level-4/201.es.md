...
7.  Desplácese hacia abajo hasta la sección del índice **"Acceso a watsonx.data con Python, Pandas y Apache** Spark". Haga clic en la flecha azul de la parte inferior derecha de la ficha "Acceso a **watsonx.** data con Spark".
